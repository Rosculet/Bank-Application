...
import com.example.bank_security.filter.AuthoritiesLoggingAfterFilter;
import com.example.bank_security.filter.AuthoritiesLoggingAtFilter;
import com.example.bank_security.filter.CsrfCookieFilter;
import com.example.bank_security.filter.RequestValidationBeforeFilter;
...
*/
    ...
    SecurityFilterChain defaultSecurityFilterChain(HttpSecurity http) throws Exception {
        ...
        http.securityContext().requireExplicitSave(false) //security context does not require explicit saving on every change
                ...
                .addFilterAfter(new CsrfCookieFilter(), BasicAuthenticationFilter.class) //adding CsrfCookieFilter in Filter Chain after BasicAuthenticationFilter(standart Filter for Auth HTTP Basic Auth)
